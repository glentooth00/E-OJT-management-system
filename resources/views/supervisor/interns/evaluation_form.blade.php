                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-5">
                                <b>
                                    <span>Name of Student Trainee: <span style="border-bottom: 1px solid gray;">({{ $interns->fullname }})</span></span>
                                    <span>Course/Year <span style="border-bottom: 1px solid gray;">({{ $interns->course }})</span></span>
                                </b>
                                <div class="mt-3">
                                    <P>Instruction:</P>
                                    <p class="text-center">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-4">
                                            <div>
                                                ...
                                                @foreach ($attendances as $attendance)
                                                    <span><input type="checkbox" name=""> {{$attendance->question }}</span><br>
                                                @endforeach
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @foreach ($punctualities as $punctuality)
                                                    <span><input type="checkbox" name=""> {{$punctuality->question }}</span><br>
                                                @endforeach
                                            </div>
                                            <div class="mt-2">
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div>
                                                <p>Rating Point</p>
                                                @foreach ($attendances as $attendance)
                                                <span>{{ $attendance->points }}</span><br>
                                                @endforeach
                                            </div>
                                            <div class="mt-4">
                                                <br>
                                                @foreach ($punctualities as $punctuality)
                                                <span>{{ $punctuality->points }}</span><br>
                                                @endforeach
                                            </div>
                                            <div class="mt-4">
                                                <br>
