                ...
                <div class="row">
                 ...
                 <div class="col-lg-7 pt-3 btns bg-primary">
                    <form action="" method="">
                        @csrf
                        <div class="p-5">
                            <div class="text-header text-light text-center mb-4"><h2>Registration</h2></div>
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="file" name="full_name" class="form-control">
                                </div>
                            ...
                            <div class="mt-4 float-right">
                                <a href="/" class="btn btn-secondary btn-lg mr-3"><i class="fas fa fa-arrow-left"></i> Back</a>
                                <button type="submit" class="btn btn-success btn-lg"> Submit <i class="fas fa fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </form>
                 </div>
