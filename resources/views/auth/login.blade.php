                ...
                <div class="row">
                 ...
                 <div class="col-lg-4 pt-5 btns bg-primary">
                    <form action="" method="">
                        @csrf
                        <div class="p-5">
                            <div class="text-header text-light text-center mb-5"><h2>Login</h2></div>
                            <div>
                            ...
                            <div>
                                 <p class="text-light mt-3">No Account yet? Please <a href="{{ route('register') }}" class="text-warning">Register here!</a></p>
                            </div>
                            <div class="mt-4">
