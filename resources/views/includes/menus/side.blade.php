 <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('admin/interns')) ? 'active' : '' }}" href="/admin/interns">
          <i class="fas fa-fw fa-users"></i>
          <span>Interns</span>
        </a>
      </li> 
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('admin/interns-evaluation')) ? 'active' : '' }}" href="/admin/interns-evaluation">
