                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="row align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Number of Registered Interns</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="row align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Number of Pending Interns</div>
