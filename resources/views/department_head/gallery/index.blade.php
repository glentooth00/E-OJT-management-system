                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="card m-2" style="width: 18rem; overflow: hidden;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        @if(empty($student->moa))
                                                            ...
                                                            <label class="badge badge-secondary p-1" style="font-size: 11px;" for="">No MOA</label>
                                                        @else
                                                            <span>
                                                            ...
                                                            <label class="badge badge-success p-1" style="font-size: 11px;" for="">MOA attached</label>
                                                    ...
                                                    <div class="col-6">
                                                        @if(empty($student->endorsement))
                                                            ...
                                                            <label class="badge badge-secondary p-1" style="font-size: 11px;" for="">No letter</label>
                                                        @else
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="#1c7430" class="bi bi-check-circle" viewBox="0 0 16 16">
                                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                                            ...
                                                            <label class="badge badge-success p-1" style="font-size: 11px; margin-left: 5px;" for="">attached</label>
                                                        </span>
                                                ...
                                                <br>
                                                <a href="#" class="btn btn-primary btn-block">View Gallery</a>
                                            </div>
                                        </div>
